...
export const spanishPatterns = {
  ...
  constraint: [
    ...
    /\d+\s+(?:\w+\s+){0,2}(?:estrategias|m[eé]todos|enfoques|maneras|soluciones|opciones|ideas|consejos|ejemplos|art[ií]culos|puntos|pasos|t[eé]cnicas|alternativas|recomendaciones|preguntas|respuestas|escenarios)\b/i,
